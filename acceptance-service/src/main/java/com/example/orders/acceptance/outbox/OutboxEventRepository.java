...
public interface OutboxEventRepository extends JpaRepository<OutboxEvent, String> {
    ...
    @Query("update OutboxEvent e set e.state = com.example.orders.acceptance.outbox.OutboxEvent$State.PUBLISHED, e.publishedAt = :at, e.lastError = null where e.id = :id")
    ...
    int markRetry(@Param("id") String id, @Param("error") String error);
}
